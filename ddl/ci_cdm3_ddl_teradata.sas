...
CONSTRAINT contact_history_fk4 FOREIGN KEY (audience_id) REFERENCES WITH NO CHECK OPTION cdm_audience_detail (audience_id),
CONSTRAINT contact_history_fk5 FOREIGN KEY (audience_occur_id) REFERENCES WITH NO CHECK OPTION cdm_audience_occur_detail (audience_occur_id)
 ) 
...
CONSTRAINT response_history_fk9 FOREIGN KEY (audience_occur_id) REFERENCES WITH NO CHECK OPTION cdm_audience_occur_detail (audience_occur_id),
CONSTRAINT response_history_fk8 FOREIGN KEY (audience_id) REFERENCES WITH NO CHECK OPTION cdm_audience_detail (audience_id)
 ) 
