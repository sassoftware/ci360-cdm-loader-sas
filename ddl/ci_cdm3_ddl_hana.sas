...
EXECUTE (CREATE COLUMN TABLE cdm_activity_detail
(
...
EXECUTE (CREATE COLUMN TABLE cdm_activity_custom_attr
(
	activity_version_id  VARCHAR(36) NOT NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_audience_detail
(
...
EXECUTE (CREATE COLUMN TABLE cdm_audience_occur_detail
(
...
EXECUTE (CREATE COLUMN TABLE cdm_business_context
(
...
EXECUTE (CREATE COLUMN TABLE cdm_campaign_detail
(
...
EXECUTE (CREATE COLUMN TABLE cdm_campaign_custom_attr
(
	campaign_id          VARCHAR(36) NOT NULL ,
	attribute_nm         VARCHAR(256) NOT NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_contact_channel
(
...
EXECUTE (CREATE COLUMN TABLE cdm_identity_map
(
...
EXECUTE (CREATE COLUMN TABLE cdm_identity_attr
(
	identity_id          VARCHAR(36) NOT NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_contact_history
(
	contact_id           VARCHAR(36) NOT NULL ,
	identity_id          VARCHAR(36) NOT NULL ,
	contact_nm           VARCHAR(256) NULL ,
	contact_dt           TIMESTAMP NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_contact_status
(
...
EXECUTE (CREATE COLUMN TABLE cdm_content_detail
(
...
EXECUTE (CREATE COLUMN TABLE cdm_content_custom_attr
(
	content_version_id   VARCHAR(40) NOT NULL ,
	attribute_nm         VARCHAR(256) NOT NULL ,
	attribute_data_type_cd VARCHAR(30) NOT NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_dyn_content_custom_attr
(
	content_version_id   VARCHAR(40) NOT NULL ,
	attribute_nm         VARCHAR(256) NOT NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_identifier_type
(
	identifier_type_id   VARCHAR(36) NOT NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_identity_type
(
...
EXECUTE (CREATE COLUMN TABLE cdm_occurrence_detail
(
...
EXECUTE (CREATE COLUMN TABLE cdm_response_channel
(
...
EXECUTE (CREATE COLUMN TABLE cdm_response_history
(
...
EXECUTE (CREATE COLUMN TABLE cdm_response_extended_attr
(
	response_id          VARCHAR(36) NOT NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_response_lookup
(
...
EXECUTE (CREATE COLUMN TABLE cdm_response_type
(
...
EXECUTE (CREATE COLUMN TABLE cdm_task_detail
(
	task_version_id      VARCHAR(36) NOT NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_task_custom_attr
(
	task_version_id      VARCHAR(36) NOT NULL ,
	attribute_nm         VARCHAR(256) NOT NULL ,
	attribute_data_type_cd VARCHAR(30) NOT NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_activity_x_task
(
	activity_version_id  VARCHAR(36) NOT NULL ,
	task_version_id      VARCHAR(36) NOT NULL ,
	updated_by_nm        VARCHAR(60) NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_rtc_detail
(
	rtc_id               VARCHAR(36) NOT NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_rtc_x_content
(
...
EXECUTE (CREATE COLUMN TABLE cdm_segment_detail
(
...
EXECUTE (CREATE COLUMN TABLE cdm_segment_custom_attr
(
	segment_version_id   VARCHAR(36) NOT NULL ,
	attribute_nm         VARCHAR(256) NOT NULL ,
	attribute_data_type_cd VARCHAR(30) NOT NULL ,
...
EXECUTE (CREATE COLUMN TABLE cdm_segment_map
(
...
EXECUTE (CREATE COLUMN TABLE cdm_segment_map_custom_attr
(
	segment_map_version_id VARCHAR(36) NOT NULL ,
	attribute_nm         VARCHAR(256) NOT NULL ,
	attribute_data_type_cd VARCHAR(30) NOT NULL ,
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_campaign_detail
	ADD CONSTRAINT  campaign_detail_pk PRIMARY KEY (campaign_id)) BY SASIOHNA;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_identity_map
	ADD CONSTRAINT  identity_map_pk PRIMARY KEY (identity_id)) BY SASIOHNA;

EXECUTE (ALTER TABLE &SCHEMA..cdm_identity_attr
	ADD CONSTRAINT  identity_attr_pk PRIMARY KEY (identity_id,identifier_type_id)) BY SASIOHNA;

EXECUTE (ALTER TABLE &SCHEMA..cdm_contact_history
	ADD CONSTRAINT  contact_history_pk PRIMARY KEY (contact_id)) BY SASIOHNA;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_content_detail
	ADD CONSTRAINT  content_detail_pk PRIMARY KEY (content_version_id)) BY SASIOHNA;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_identifier_type
	ADD CONSTRAINT  identifier_type_pk PRIMARY KEY (identifier_type_id)) BY SASIOHNA;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_response_history
	ADD CONSTRAINT  response_history_pk PRIMARY KEY (response_id)) BY SASIOHNA;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_task_detail
	ADD CONSTRAINT  task_detail_pk PRIMARY KEY (task_version_id)) BY SASIOHNA;
...
(rtc_id ASC, content_version_id ASC, content_hash_val ASC, sequence_no ASC)) BY SASIOHNA;
