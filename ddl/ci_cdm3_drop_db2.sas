...
EXECUTE (DROP TABLE &SCHEMA..cdm_segment_test_x_segment) BY DB2;

EXECUTE (DROP TABLE &SCHEMA..cdm_segment_test) BY DB2;
...
EXECUTE (DROP TABLE &SCHEMA..cdm_audience_occur_detail) BY DB2;

EXECUTE (DROP TABLE &SCHEMA..cdm_audience_detail) BY DB2;
