...
EXECUTE (DROP TABLE &SCHEMA..cdm_audience_occur_detail CASCADE) BY GREENPLM;

EXECUTE (DROP TABLE &SCHEMA..cdm_audience_detail CASCADE) BY GREENPLM;
...
EXECUTE (DROP TABLE &SCHEMA..cdm_segment_test_x_segment CASCADE) BY GREENPLM;

EXECUTE (DROP TABLE &SCHEMA..cdm_segment_test CASCADE) BY GREENPLM;
