...
(
	...
	contact_content_desc VARCHAR(32000)  ,
...
(
	...
	segment_map_desc     VARCHAR(32000)  ,
...
EXECUTE ( ALTER TABLE &SCHEMA..cdm_campaign_detail
	ADD CONSTRAINT  campaign_pk PRIMARY KEY (campaign_id)) BY SASIOSNF;
...
EXECUTE ( ALTER TABLE &SCHEMA..cdm_identity_map
	ADD CONSTRAINT  identity_pk PRIMARY KEY (identity_id)) BY SASIOSNF;

EXECUTE ( ALTER TABLE &SCHEMA..cdm_contact_history
	ADD CONSTRAINT  contact_pk PRIMARY KEY (contact_id)) BY SASIOSNF;
...
EXECUTE ( ALTER TABLE &SCHEMA..cdm_content_detail
	ADD CONSTRAINT  contact_content_pk PRIMARY KEY (content_version_id)) BY SASIOSNF;
...
EXECUTE ( ALTER TABLE &SCHEMA..cdm_response_history
	ADD CONSTRAINT  response_pk PRIMARY KEY (response_id)) BY SASIOSNF;
...
EXECUTE ( ALTER TABLE &SCHEMA..cdm_task_detail
	ADD CONSTRAINT  task_pk PRIMARY KEY (task_version_id)) BY SASIOSNF;
