...
EXECUTE (DROP TABLE &SCHEMA..cdm_segment_test_x_segment) BY SASIOGBQ;

EXECUTE (DROP TABLE &SCHEMA..cdm_segment_test) BY SASIOGBQ;
...
EXECUTE (DROP TABLE &SCHEMA..cdm_audience_occur_detail) BY SASIOGBQ;

EXECUTE (DROP TABLE &SCHEMA..cdm_audience_detail) BY SASIOGBQ;
