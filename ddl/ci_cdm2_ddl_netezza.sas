...
(
	...
	valid_to_dttm        TIMESTAMP  ,
	user_identifier_val  VARCHAR(32762)  ,
...
DISTRIBUTE ON (contact_status_cd)
) 
BY NETEZZA;
...
(
	...
	contact_content_desc VARCHAR(32762)  ,
...
DISTRIBUTE ON (identifier_type_id)
) 
BY NETEZZA;
...
DISTRIBUTE ON (identity_type_cd)
) 
BY NETEZZA;
...
DISTRIBUTE ON (response_channel_cd)
) 
BY NETEZZA;
...
(
	...
	segment_map_desc     VARCHAR(32762)  ,
