...
EXECUTE (ALTER TABLE &SCHEMA..cdm_audience_detail
	ADD CONSTRAINT  audience_detail_pk PRIMARY KEY (audience_id)) BY SASIORST;

EXECUTE (ALTER TABLE &SCHEMA..cdm_audience_occur_detail
	ADD CONSTRAINT  audience_occur_detail_pk PRIMARY KEY (audience_occur_id)) BY SASIORST;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_campaign_detail
	ADD CONSTRAINT  campaign_detail_pk PRIMARY KEY (campaign_id)) BY SASIORST;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_identity_map
	ADD CONSTRAINT  identity_map_pk PRIMARY KEY (identity_id)) BY SASIORST;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_contact_history
	ADD CONSTRAINT  contact_history_pk PRIMARY KEY (contact_id)) BY SASIORST;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_content_detail
	ADD CONSTRAINT  content_detail_pk PRIMARY KEY (content_version_id)) BY SASIORST;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_identifier_type
	ADD CONSTRAINT  identifier_type_pk PRIMARY KEY (identifier_type_id)) BY SASIORST;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_response_history
	ADD CONSTRAINT  response_history_pk PRIMARY KEY (response_id)) BY SASIORST;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_task_detail
	ADD CONSTRAINT  task_detail_pk PRIMARY KEY (task_version_id)) BY SASIORST;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_audience_occur_detail
	ADD CONSTRAINT audience_occur_detail_fk1 FOREIGN KEY (audience_id) REFERENCES &SCHEMA..cdm_audience_detail (audience_id)) BY SASIORST;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_contact_history
	ADD CONSTRAINT contact_history_fk4 FOREIGN KEY (audience_id) REFERENCES &SCHEMA..cdm_audience_detail (audience_id)) BY SASIORST;

EXECUTE (ALTER TABLE &SCHEMA..cdm_contact_history
	ADD CONSTRAINT contact_history_fk5 FOREIGN KEY (audience_occur_id) REFERENCES &SCHEMA..cdm_audience_occur_detail (audience_occur_id)) BY SASIORST;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_response_history
	ADD CONSTRAINT response_history_fk9 FOREIGN KEY (audience_occur_id) REFERENCES &SCHEMA..cdm_audience_occur_detail (audience_occur_id)) BY SASIORST;

EXECUTE (ALTER TABLE &SCHEMA..cdm_response_history
	ADD CONSTRAINT response_history_fk8 FOREIGN KEY (audience_id) REFERENCES &SCHEMA..cdm_audience_detail (audience_id)) BY SASIORST;
...
EXECUTE (ALTER TABLE &SCHEMA..cdm_segment_test_x_segment
	ADD CONSTRAINT segment_test_x_segment_fk1 FOREIGN KEY (test_cd, task_version_id, task_id) REFERENCES &SCHEMA..cdm_segment_test (test_cd, task_version_id, task_id)) BY SASIORST;
